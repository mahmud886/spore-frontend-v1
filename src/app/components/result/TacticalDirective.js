...
export default function TacticalDirective({
  ...
  const defaultDescription = (
    <>
      The containment walls are <span className="bg-primary/20 px-1 text-primary">compromised</span>.
      Your broadcast signal is currently boosting the <span className="text-primary">Evolution</span>{' '}
      frequency by 0.12%. Maintain position and continue transmission.
    </>
  );
  ...
  return (
    <div className="space-y-6">
      <div className="bg-terminal-gray/20 border border-white/5 p-6 h-full flex flex-col">
        ...
        <p className="text-sm text-white/60 leading-relaxed mb-8 italic">
