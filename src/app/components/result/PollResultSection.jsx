  ...
  return (
    <section className="mb-24">
      <div className="flex justify-between items-end mb-2">
        <div>
          <h3 className="text-primary text-xs font-bold tracking-widest uppercase mb-1">{faction1.name}</h3>
      ...
      <div className="h-10 w-full flex overflow-hidden border border-white/10">
        <div className="striped-lime flex items-center px-4" style={{ width: `${faction1.percentage}%` }}>
          <span className="text-black font-black italic">{faction1.percentage}%</span>
        </div>
        <div className="striped-blue flex items-center justify-end px-4" style={{ width: `${faction2.percentage}%` }}>
