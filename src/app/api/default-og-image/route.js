  ...
  try {
    ...
    const svg = `
      <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Subtitle -->
        <text x="${width / 2}" y="${logoY + 80}" font-size="28" font-weight="600" fill="#FFFFFF" text-anchor="middle" font-family="Arial, Helvetica, sans-serif">
          The city of Lionara is quarantined
        </text>

        <!-- Spore text -->
        <text x="${width / 2}" y="${height - verticalMargin - 110}" font-size="32" font-weight="700" fill="#FFFFFF" text-anchor="middle" font-family="Arial, Helvetica, sans-serif">A spore is rewriting human fate</text>
